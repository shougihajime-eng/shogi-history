...
export const LAST_VERIFIED = "2026年5月30日";
...
export const TITLES: Title[] = [
  ...
  },
  {
    ...
    koma: "叡",
    holder: "伊藤匠",
    holderNote: "2026年5月30日時点で防衛中（叡王戦五番勝負は2勝2敗。5月31日の第5局で決着＝結果が出たら要更新）",
    eiseiName: "永世叡王",
...
export const CURRENT_HOLDERS = {
  note: "2026年5月30日時点。藤井聡太が六冠（竜王・名人・王位・棋聖・王将・棋王）、伊藤匠が二冠（叡王・王座）を保持。",
